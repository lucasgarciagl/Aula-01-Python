...
ChopDesperdicado = float(input('Digite a quantidadade de chopp desperdicado: '))
ChopSobra = float(input('Digite a quantidadade que sobrou de chopp: '))

totalChopp = 300
totalPessoas  = 45

mediaPorPessoa = (totalChopp - ChopDesperdicado - ChopSobra)  / totalPessoas

print(f'O a media de chopp bebido por pessoa foi de: {mediaPorPessoa}')